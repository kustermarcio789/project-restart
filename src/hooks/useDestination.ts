...
export interface Destination {
  ...
  neighborhoods: { name: string; description: string; avg_rent: string; profile: string }[];
  common_scams: { title: string; description: string }[];
  documents_required: Record<string, unknown>;
