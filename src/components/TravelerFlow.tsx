...
import { MapPin, Calendar, Users, Plane, Building2, Shield, ChevronRight, ChevronLeft, Check, Search } from 'lucide-react';
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 max-h-[300px] overflow-y-auto pr-1">
                  {filteredDests.map(d => (
                    ...
                    >
                      ...
                      <div className="absolute top-2 left-2 text-[10px] font-bold text-accent bg-black/50 rounded-full px-2 py-0.5">
                        {format(d.priceBRL)}
                      </div>
                      {selectedDest === d.id && (
